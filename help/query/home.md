---
audience: end-user
title: Panoramica di Query Modeler
description: Scopri come utilizzare il modellatore di query per definire regole per filtrare il database.
...
# Panoramica sul query modeler {#query-modeler}
...
| **Personalizza attività**: applica le regole nelle attività di composizione, ad esempio **Dividi** e **Riconciliazione**, per allinearle ai requisiti specifici. [Ulteriori informazioni sulle attività di composizione](../compositions/activities.md) | ![](assets/access-composition.png){zoomable="yes"}{width="200" align="center" zoomable="yes"} |
