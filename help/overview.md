...
* **Espandi l&#39;accesso ai set di dati critici basati su data warehouse per creare tipi di pubblico di alto valore**: puoi utilizzare i data warehouse esistenti come sistema principale di record, sfruttando al contempo le applicazioni migliori per fornire ai clienti esperienze ottimali.

* **Supporto completo per casi d&#39;uso di coinvolgimento**: Federated Audience Composition, in combinazione con Real-Time CDP o Journey Optimizer, supporta esperienze personalizzate avviate dal brand con tipi di pubblico federati e offre esperienze istantanee attivate da eventi in tempo reale, combinate con attributi di persona per soddisfare i requisiti dei casi d&#39;uso tra i team.

* **Riduci al minimo lo spostamento e la duplicazione dei dati**: puoi creare tipi di pubblico da set di dati che risiedono in data warehouse aziendali senza copiare i dati sottostanti per gestire profili di marketing e tipi di pubblico utilizzabili.

* **Utilizzo di un singolo sistema per flussi di lavoro basati sull&#39;esperienza**: puoi curare sia i tipi di pubblico acquisiti che quelli federati in Adobe Experience Platform e coordinare le esperienze in uscita su tutti i canali.

* **Supporto multiedizione**: i clienti CDP B2C e B2B possono sfruttare la Federated Audience Composition per creare tipi di pubblico basati sulle persone integrando i dati dai data warehouse aziendali supportati. Inoltre, possono arricchire il pubblico esistente basato sulle persone di Experience Platform incorporando gli attributi pertinenti disponibili nel data warehouse aziendale, migliorando i profili di pubblico per un coinvolgimento più personalizzato e mirato.
...
1. **Crea una connessione**: riunisci i dati provenienti da varie origini e uniscili in un set di dati unificato. Per ulteriori informazioni sulla connessione delle app Adobe Experience Platform al data warehouse aziendale, ai database supportati e alla configurazione della connessione, leggere la [panoramica sulle connessioni](./connections/home.md).

2. **Modellare i dati**: progettare e creare schemi e modelli di dati che definiscano la struttura, le relazioni e i vincoli dei dati. Per ulteriori informazioni sugli schemi, leggere la [panoramica dello schema](./data-modelling/schemas.md). Per ulteriori informazioni sui modelli dati, leggere la [panoramica sul modello dati](./data-modelling/models.md).

3. **Trasforma i dati**: applica tecniche di manipolazione dei dati per modificare il formato, la struttura o i valori degli elementi dati in modo da renderli compatibili o adatti a specifiche analisi o applicazioni.

4. **Componi il pubblico**: crea, gestisci e crea i tipi di pubblico. Per ulteriori informazioni sulla composizione dei tipi di pubblico, leggere la [panoramica sulla composizione](./compositions/home.md). Puoi anche aggiornare o riutilizzare i tipi di pubblico esistenti tramite Adobe Experience Platform Audience Portal e le destinazioni. Ulteriori informazioni sono disponibili in [questa pagina](./connections/destinations.md).
...
La funzionalità di audit trail fornisce una registrazione dettagliata e cronologica di tutte le azioni e di tutti gli eventi che sono stati eseguiti nell’ambiente in tempo reale. Per ulteriori informazioni sull&#39;audit trail, leggere la [panoramica sull&#39;audit trail](./admin/audit-trail.md).

## Ulteriori informazioni {#learn}

<!-- Workflow + Workflow activities-->

Ulteriori informazioni su come accedere alla composizione di pubblico federato, a guardrail e limitazioni sono disponibili in [questa pagina](./start/access-prerequisites.md).

Per le risposte alle domande frequenti, leggi le [Domande frequenti sulla composizione del pubblico federato](./faq.md).
...
>abstract="La dimensione targeting consente di definire la popolazione target dell’operazione: destinatari, beneficiari del contratto, operatore, iscritti, ecc. Per impostazione predefinita, per le e-mail e gli SMS, il target viene selezionato dalla tabella incorporata Destinatari. Per le notifiche push, la dimensione di destinazione predefinita è Applicazioni in abbonamento."
