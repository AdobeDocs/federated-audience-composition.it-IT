...
Consente inoltre connessioni sicure ai database Database ospitati su Amazon Web Services (AWS). [Ulteriori informazioni](../connections/federated-db.md#databricks)
